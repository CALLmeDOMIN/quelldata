      ...
      <section className="space-y-6 text-neutral-600 dark:text-neutral-400">
        <div className="space-y-2">
          ...
          <p>
            ...
            powered by blockchain and crowdsourced intelligence. These Terms and
            Conditions ("Terms") govern your access to and use of the Quelldata
            website, smart contracts, and any related services (the "Platform").
        ...
        <div className="space-y-2">
          ...
          <ul className="list-disc ml-6 space-y-1">
            ...
            <li>
              <strong>Smart Contract</strong> – self-executing code deployed on
              a blockchain, used for validation and rewards
            </li>
            <li>
              <strong>Digital Asset</strong> – any token or cryptocurrency used
              within the Platform
            </li>
          </ul>
        </div>
        ...
        <div className="space-y-2">
          ...
          <p>
            We may integrate with services including blockchain networks, wallet
            providers, data storage (e.g. IPFS), and analytics. Use of such
        ...
        <div className="space-y-2">
          ...
          <p>
            ...
            guaranteed access. Use of the Platform is entirely at your own risk.
          </p>
        </div>
        ...
        <div className="space-y-2">
          ...
          <p>
            ...
            posting. Continued use of the Platform means you accept the updated
            version.
          </p>
        </div>
